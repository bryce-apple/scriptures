% ----------------------
\subsection{Words of Mormon}
% ----------------------
	\label{WORDSOFMORMON}

	% -----
	\subsubsection{Words of Mormon 1} % *WORDSOFMORMON-1
	% -----
		\label{WORDSOFMORMON-1}
	
		% ---
		\paragraph{Words of Mormon 1:1} % *WORDSOFMORMON-1-1 
		% ---
			\label{WORDSOFMORMON-1-1}
		...
		% ---
		\paragraph{Words of Mormon 1:2} % *WORDSOFMORMON-1-2 
		% ---
			\label{WORDSOFMORMON-1-2}
		...
		% ---
		\paragraph{Words of Mormon 1:3} % *WORDSOFMORMON-1-3 
		% ---
			\label{WORDSOFMORMON-1-3}
		...
		% ---
		\paragraph{Words of Mormon 1:4} % *WORDSOFMORMON-1-4 
		% ---
			\label{WORDSOFMORMON-1-4}
		...
		% ---
		\paragraph{Words of Mormon 1:5} % *WORDSOFMORMON-1-5 
		% ---
			\label{WORDSOFMORMON-1-5}
		...
		% ---
		\paragraph{Words of Mormon 1:6} % *WORDSOFMORMON-1-6 
		% ---
			\label{WORDSOFMORMON-1-6}
		...
		% ---
		\paragraph{Words of Mormon 1:7} % *WORDSOFMORMON-1-7 
		% ---
			\label{WORDSOFMORMON-1-7}
			...
			but the Lord knoweth all things which is to come;
			wherefore he worketh in me to do according to his will.

		% ---
		\paragraph{Words of Mormon 1:8} % *WORDSOFMORMON-1-8 
		% ---
			\label{WORDSOFMORMON-1-8}

			And my prayer to God is concerning my brethren,
			that they may once again come to the knowledge of God,
			yea, the redemption of Christ,
			that they may once again be a delightsome people.

		% ---
		\paragraph{Words of Mormon 1:9} % *WORDSOFMORMON-1-9 
		% ---
			\label{WORDSOFMORMON-1-9}

			And now I Mormon proceed to finish out my record
			which I take from the plates of Nephi;
			and I make it according to the knowledge and the understanding
			which God hath given me.

		% ---
		\paragraph{Words of Mormon 1:10} % *WORDSOFMORMON-1-10 
		% ---
			\label{WORDSOFMORMON-1-10}

			Wherefore it came to pass that
			after Amaleki had delivered up these plates into the hands of king Benjamin,
			he took them and put them with the other plates,
			which contained records which had been handed down
			by the kings from generation to generation until the days of king Benjamin.

		% ---
		\paragraph{Words of Mormon 1:11} % *WORDSOFMORMON-1-11 
		% ---
			\label{WORDSOFMORMON-1-11}

			And they were handed down from king Benjamin from generation to generation
			until they have fallen into my hands.
			And I Mormon pray to God
			that they may be preserved from this time henceforth.
		...
		% ---
		\paragraph{Words of Mormon 1:12} % *WORDSOFMORMON-1-12 
		% ---
			\label{WORDSOFMORMON-1-12}

			And now concerning this king Benjamin:
			he had somewhat contentions among his own people.

		% ---
		\paragraph{Words of Mormon 1:13} % *WORDSOFMORMON-1-13 
		% ---
			\label{WORDSOFMORMON-1-13}

			And it came to pass also that the armies of the Lamanites came down
			out of the land of Nephi to battle against his people.
		...
		% ---
		\paragraph{Words of Mormon 1:14} % *WORDSOFMORMON-1-14 
		% ---
			\label{WORDSOFMORMON-1-14}
		...
		% ---
		\paragraph{Words of Mormon 1:15} % *WORDSOFMORMON-1-15 
		% ---
			\label{WORDSOFMORMON-1-15}
		...
		% ---
		\paragraph{Words of Mormon 1:16} % *WORDSOFMORMON-1-16 
		% ---
			\label{WORDSOFMORMON-1-16}
		...
		% ---
		\paragraph{Words of Mormon 1:17} % *WORDSOFMORMON-1-17 
		% ---
			\label{WORDSOFMORMON-1-17}
		...
		% ---
		\paragraph{Words of Mormon 1:18} % *WORDSOFMORMON-1-18 
		% ---
			\label{WORDSOFMORMON-1-18}
