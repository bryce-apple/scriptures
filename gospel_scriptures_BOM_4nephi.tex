...
% ----------------------
	...
	% -----
	\subsubsection{4 Nephi 1}
	% -----
		\label{4NEPHI-1}
	
		% ---
		\paragraph{4 Nephi 1:1} % *4NEPHI-1-1 
		% ---
			\label{4NEPHI-1-1}

			And it came to pass that the thirty and fourth year passed away,
			and also the thirty and fifth,
			and behold, the disciples of Jesus had formed a church of Christ
			in all the lands round about.
			And as many as did come unto them and did truly repent of their sins
			were baptized in the name of Jesus;
			and they did also receive the Holy Ghost.

		% ---
		\paragraph{4 Nephi 1:2} % *4NEPHI-1-2 
		% ---
			\label{4NEPHI-1-2}
		...
		% ---
		\paragraph{4 Nephi 1:4} % *4NEPHI-1-4 
		% ---
			\label{4NEPHI-1-4}
		...
		% ---
		\paragraph{4 Nephi 1:5} % *4NEPHI-1-5 
		% ---
			\label{4NEPHI-1-5}

			And there were great and marvelous works wrought by the disciples of Jesus,
			insomuch that they did heal the sick and raise the dead
			and cause the lame to walk and the blind to receive their sight and the deaf to hear.
		...
		% ---
		\paragraph{4 Nephi 1:6} % *4NEPHI-1-6 
		% ---
			\label{4NEPHI-1-6}
		...
		% ---
		\paragraph{4 Nephi 1:7} % *4NEPHI-1-7 
		% ---
			\label{4NEPHI-1-7}
		...
		% ---
		\paragraph{4 Nephi 1:8} % *4NEPHI-1-8 
		% ---
			\label{4NEPHI-1-8}
		...
		% ---
		\paragraph{4 Nephi 1:9} % *4NEPHI-1-9 
		% ---
			\label{4NEPHI-1-9}
		...
		% ---
		\paragraph{4 Nephi 1:10} % *4NEPHI-1-10 
		% ---
			\label{4NEPHI-1-10}

			And now behold, it came to pass that
			the people of Nephi did wax strong and did multiply exceeding fast
			and became an exceeding fair and delightsome people.

		% ---
		\paragraph{4 Nephi 1:11} % *4NEPHI-1-11 
		% ---
			\label{4NEPHI-1-11}

			And they were married and given in marriage,
			and were blessed according to the multitude of the promises
			which the Lord had made unto them.

		% ---
		\paragraph{4 Nephi 1:12} % *4NEPHI-1-12 
		% ---
			\label{4NEPHI-1-12}
		...
		% ---
		\paragraph{4 Nephi 1:13} % *4NEPHI-1-13 
		% ---
			\label{4NEPHI-1-13}
		...
		% ---
		\paragraph{4 Nephi 1:14} % *4NEPHI-1-14 
		% ---
			\label{4NEPHI-1-14}
			...
			had all gone to the paradise of God,
		...
		% ---
		\paragraph{4 Nephi 1:15} % *4NEPHI-1-15 
		% ---
			\label{4NEPHI-1-15}
		...
		% ---
		\paragraph{4 Nephi 1:16} % *4NEPHI-1-16 
		% ---
			\label{4NEPHI-1-16}

			And there were no envyings nor strifes nor tumults nor whoredoms
			nor lyings nor murders nor no manner of lasciviousness.
			And surely there could not be a happier people
			among all the people which had been created by the hand of God.

		% ---
		\paragraph{4 Nephi 1:17} % *4NEPHI-1-17 
		% ---
			\label{4NEPHI-1-17}
		...
		% ---
		\paragraph{4 Nephi 1:18} % *4NEPHI-1-18 
		% ---
			\label{4NEPHI-1-18}

			And how blessed were they!
			For the Lord did bless them in all their doings;
			yea, even they were blessed and prospered
			until an hundred and ten years had passed away.
			And the first generation from Christ had passed away,
			and there was no contention in all the land.

		% ---
		\paragraph{4 Nephi 1:19} % *4NEPHI-1-19 
		% ---
			\label{4NEPHI-1-19}
			...
			died, and his son Amos kept it in his stead.
			And he kept it upon the plates of Nephi also;

		% ---
		\paragraph{4 Nephi 1:20} % *4NEPHI-1-20 
		% ---
			\label{4NEPHI-1-20}
			...
			and took upon them the name of Lamanites;
			therefore there began to be Lamanites again in the land.

		% ---
		\paragraph{4 Nephi 1:21} % *4NEPHI-1-21 
		% ---
			\label{4NEPHI-1-21}
		...
		% ---
		\paragraph{4 Nephi 1:22} % *4NEPHI-1-22 
		% ---
			\label{4NEPHI-1-22}
		...
		% ---
		\paragraph{4 Nephi 1:23} % *4NEPHI-1-23 
		% ---
			\label{4NEPHI-1-23}

			And now I Mormon would that ye should know
			that the people had multiplied,
		...
		% ---
		\paragraph{4 Nephi 1:24} % *4NEPHI-1-24 
		% ---
			\label{4NEPHI-1-24}
		...
		% ---
		\paragraph{4 Nephi 1:25} % *4NEPHI-1-25 
		% ---
			\label{4NEPHI-1-25}
		...
		% ---
		\paragraph{4 Nephi 1:26} % *4NEPHI-1-26 
		% ---
			\label{4NEPHI-1-26}
		...
		% ---
		\paragraph{4 Nephi 1:27} % *4NEPHI-1-27 
		% ---
			\label{4NEPHI-1-27}
		...
		% ---
		\paragraph{4 Nephi 1:28} % *4NEPHI-1-28 
		% ---
			\label{4NEPHI-1-28}
		...
		% ---
		\paragraph{4 Nephi 1:29} % *4NEPHI-1-29 
		% ---
			\label{4NEPHI-1-29}
		...
		% ---
		\paragraph{4 Nephi 1:30} % *4NEPHI-1-30 
		% ---
			\label{4NEPHI-1-30}

			Therefore they did exercise power and authority
			over the disciples of Jesus which did tarry with them.
		...
		% ---
		\paragraph{4 Nephi 1:31} % *4NEPHI-1-31 
		% ---
			\label{4NEPHI-1-31}

			Nevertheless—and notwithstanding all these miracles—
			the people did harden their hearts
			and did seek to kill them,
			even as the Jews at Jerusalem sought to kill Jesus,
			according to his word.

		% ---
		\paragraph{4 Nephi 1:32} % *4NEPHI-1-32 
		% ---
			\label{4NEPHI-1-32}

			And they did cast them into furnaces of fire,
			and they came forth receiving no harm.

		% ---
		\paragraph{4 Nephi 1:33} % *4NEPHI-1-33 
		% ---
			\label{4NEPHI-1-33}
		...
		% ---
		\paragraph{4 Nephi 1:34} % *4NEPHI-1-34 
		% ---
			\label{4NEPHI-1-34}
		...
		% ---
		\paragraph{4 Nephi 1:35} % *4NEPHI-1-35 
		% ---
			\label{4NEPHI-1-35}

			And now it came to pass in this year
			—yea, in the two hundred and thirty and first year—
			there were a great division among the people.

		% ---
		\paragraph{4 Nephi 1:36} % *4NEPHI-1-36 
		% ---
			\label{4NEPHI-1-36}

			And it came to pass that in this year
			there arose a people which was called the Nephites,
			and they were true believers in Christ.
			And among them there were they which was called by the Lamanites
			Jacobites and Josephites and Zoramites.

		% ---
		\paragraph{4 Nephi 1:37} % *4NEPHI-1-37 
		% ---
			\label{4NEPHI-1-37}

			Therefore the true believers in Christ and the true worshippers of Christ,
			among whom were the three disciples of Jesus which should tarry,
			were called Nephites and Jacobites and Josephites and Zoramites.

		% ---
		\paragraph{4 Nephi 1:38} % *4NEPHI-1-38 
		% ---
			\label{4NEPHI-1-38}
		...
		% ---
		\paragraph{4 Nephi 1:39} % *4NEPHI-1-39 
		% ---
			\label{4NEPHI-1-39}

			And it was because of the wickedness and abominations of their fathers,
			even as it was in the beginning.
			And they were taught to hate the children of God,
			even as the Lamanites were taught
			to hate the children of Nephi from the beginning.

		% ---
		\paragraph{4 Nephi 1:40} % *4NEPHI-1-40 
		% ---
			\label{4NEPHI-1-40}
		...
		% ---
		\paragraph{4 Nephi 1:41} % *4NEPHI-1-41 
		% ---
			\label{4NEPHI-1-41}
		...
		% ---
		\paragraph{4 Nephi 1:42} % *4NEPHI-1-42 
		% ---
			\label{4NEPHI-1-42}
		...
		% ---
		\paragraph{4 Nephi 1:43} % *4NEPHI-1-43 
		% ---
			\label{4NEPHI-1-43}

			And also the people which were called the people of Nephi began
			to be proud in their hearts because of their exceeding riches
			and became vain like unto their brethren the Lamanites.

		% ---
		\paragraph{4 Nephi 1:44} % *4NEPHI-1-44 
		% ---
			\label{4NEPHI-1-44}
		...
		% ---
		\paragraph{4 Nephi 1:45} % *4NEPHI-1-45 
		% ---
			\label{4NEPHI-1-45}
		...
		% ---
		\paragraph{4 Nephi 1:46} % *4NEPHI-1-46 
		% ---
			\label{4NEPHI-1-46}

			And it came to pass that
			the robbers of Gaddianton did spread over all the face of the land.
		...
		% ---
		\paragraph{4 Nephi 1:47} % *4NEPHI-1-47 
		% ---
			\label{4NEPHI-1-47}

			And it came to pass that after three hundred and five years had passed away
			—and the people did still remain in wickedness—
			and Amos died, and his brother Ammaron did keep the record in his stead.

		% ---
		\paragraph{4 Nephi 1:48} % *4NEPHI-1-48 
		% ---
			\label{4NEPHI-1-48}
			...
			yea, even all the sacred records which had been handed down
			from generation to generation, which were sacred,
			even until the three hundred and twentieth year from the coming of Christ.

		% ---
		\paragraph{4 Nephi 1:49} % *4NEPHI-1-49 
		% ---
			\label{4NEPHI-1-49}

			And he did hide them up unto the Lord,
			that they might come again unto the remnant of the house of Jacob,
			according to the prophecies and the promises of the Lord.
