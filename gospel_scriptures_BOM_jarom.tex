...
% ----------------------
	...
	% -----
	\subsubsection{Jarom 1} % *JAROM-1
	% -----
		\label{JAROM-1}
	
		% --
		\paragraph{Jarom 1:1} % *JAROM-1-1
		% ---
			\label{JAROM-1-1}
		...
		% --
		\paragraph{Jarom 1:4} % *JAROM-1-4 
		% ---
			\label{JAROM-1-4}

			And there are many among us which have many revelations,
		...
		% --
		\paragraph{Jarom 1:8} % *JAROM-1-8 
		% ---
			\label{JAROM-1-8}

			And we multiplied exceedingly and spread upon the face of the land
			and became exceeding rich in gold and in silver and in precious things
		...
		% --
		\paragraph{Jarom 1:10} % *JAROM-1-10 
		% ---
			\label{JAROM-1-10}
		...
		% --
		\paragraph{Jarom 1:11} % *JAROM-1-11 
		% ---
			\label{JAROM-1-11}
		...
		% --
		\paragraph{Jarom 1:12} % *JAROM-1-12 
		% ---
			\label{JAROM-1-12}
		...
		% --
		\paragraph{Jarom 1:13} % *JAROM-1-13 
		% ---
			\label{JAROM-1-13}
		...
		% --
		\paragraph{Jarom 1:14} % *JAROM-1-14 
		% ---
			\label{JAROM-1-14}
		...
		% --
		\paragraph{Jarom 1:15} % *JAROM-1-15 
		% ---
			\label{JAROM-1-15}
