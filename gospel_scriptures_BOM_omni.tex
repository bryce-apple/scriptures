...
% ----------------------
	...
	% -----
	\subsubsection{Omni 1} % *OMNI-1
	% -----
		\label{OMNI-1}
	
		% ---
		\paragraph{Omni 1:1} % *OMNI-1-1 
		% ---
			\label{OMNI-1-1}
		...
		% ---
			...
			and I conferred them upon my son Amaron.
			And I make an end.

		% ---
		\paragraph{Omni 1:4} % *OMNI-1-4 
		% ---
			\label{OMNI-1-4}

			And now I Amaron write the things whatsoever I write,
			which are few, in the book of my father.

		% ---
		\paragraph{Omni 1:5} % *OMNI-1-5 
		% ---
			\label{OMNI-1-5}
		...
		% ---
			...
			And after this manner we keep the record,
			for it is according to the commandments of our fathers.
			And I make an end.

		% ---
		\paragraph{Omni 1:10} % *OMNI-1-10 
		% ---
			\label{OMNI-1-10}

			Behold, I Abinadom I am the son of Chemish.
			Behold, it came to pass that I saw much war and contention
			between my people the Nephites and the Lamanites.
			And I with mine own sword have taken the lives of many of the Lamanites
			in the defense of my brethren.

		% ---
		\paragraph{Omni 1:11} % *OMNI-1-11 
		% ---
			\label{OMNI-1-11}

			And behold, the record of this people is engraven upon plates,
			which is had by the kings according to the generations.
			And I know of no revelation save that which has been written, neither prophecy.
			Wherefore that which is sufficient is written.
			And I make an end.

		% ---
		\paragraph{Omni 1:12} % *OMNI-1-12 
		% ---
			\label{OMNI-1-12}

			Behold, I am Amaleki the son of Abinadom.
			Behold, I will speak unto you somewhat concerning Mosiah,
			which was made king over the land of Zarahemla.
		...
		% ---
		\paragraph{Omni 1:14} % *OMNI-1-14 
		% ---
			\label{OMNI-1-14}

			And they discovered a people which was called the people of Zarahemla.
			Now there was great rejoicing among the people of Zarahemla,
			and also Zarahemla did rejoice exceedingly
			because that the Lord had sent the people of Mosiah
			with the plates of brass, which contained the record of the Jews.

		% ---
		\paragraph{Omni 1:15} % *OMNI-1-15 
		% ---
			\label{OMNI-1-15}

			Behold, it came to pass that Mosiah discovered
			that the people of Zarahemla came out from Jerusalem at the time
			that Zedekiah, king of Judah, was carried away captive into Babylon;

		% ---
		\paragraph{Omni 1:16} % *OMNI-1-16 
		% ---
			\label{OMNI-1-16}
		...
		% ---
		\paragraph{Omni 1:17} % *OMNI-1-17 
		% ---
			\label{OMNI-1-17}

			And at the time that Mosiah discovered them,
			they had became exceeding numerous.
		...
		% ---
			...
			\footnote{%
				% \label{}%
				This thing about ``nine moons'' is so strange---this is the only place in the BOM where ``moon'' is used in this way, in the context of keeping track of time. It may be that this is language taken from the stone that Mosiah translated, which would help explain why it doesn't appear elsewhere.
				}%
			for the space of nine moons.

		% ---
		\paragraph{Omni 1:22} % *OMNI-1-22 
		% ---
			\label{OMNI-1-22}

			It also spake a few words concerning his fathers;
			and his first parents came out from the tower
			at the time the Lord confounded the language of the people.
			And the severity of the Lord fell upon them
			according to his judgments, which is just,
			and their bones lay scattered in the land northward.

		% ---
		\paragraph{Omni 1:23} % *OMNI-1-23 
		% ---
			\label{OMNI-1-23}
		...
		% ---
		\paragraph{Omni 1:29} % *OMNI-1-29 
		% ---
			\label{OMNI-1-29}

			And it came to pass that they also took others to a considerable number
			and took their journey again into the wilderness.

		% ---
		\paragraph{Omni 1:30} % *OMNI-1-30 
		% ---
			\label{OMNI-1-30}

			And I Amaleki had a brother which also went with them;
			and I have not since known concerning them.
			And I am about to lay down in my grave;
			and these plates are full,
