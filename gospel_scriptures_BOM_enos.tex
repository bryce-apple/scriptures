...
% ----------------------
	...
	% -----
	\subsubsection{Enos 1} % *ENOS-1
	% -----
		\label{ENOS-1}
	
		% ---
		\paragraph{Enos 1:1} % *ENOS-1-1 
		% ---
			\label{ENOS-1-1}
		...
		% ---
		\paragraph{Enos 1:8} % *ENOS-1-8 
		% ---
			\label{ENOS-1-8}

			And he saith unto me:
			Because of thy faith in Christ,
			whom thou hast not heard nor seen
		...
		% ---
			...
			that it might be brought forth some future day unto the Lamanites,
			that perhaps they might be brought unto salvation.

		% ---
		\paragraph{Enos 1:14} % *ENOS-1-14 
		% ---
			\label{ENOS-1-14}
		...
		% ---
		\paragraph{Enos 1:17} % *ENOS-1-17 
		% ---
			\label{ENOS-1-17}

			And I Enos knew that it would be according to the covenant which he had made;
			wherefore my soul did rest.

		% ---
		\paragraph{Enos 1:18} % *ENOS-1-18 
		% ---
			\label{ENOS-1-18}
		...
		% ---
			...
			and of the duration of eternity and the judgments and the power of God,
