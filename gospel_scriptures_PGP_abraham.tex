...
% ----------------------
	...
	% -----
	\subsubsection{Abraham 1} % *ABRAHAM-1
	% -----
		\label{ABRAHAM-1}
		
		% ---
		\paragraph{Abraham 1:1} % *ABRAHAM-1-1 
		% ---
			\label{ABRAHAM-1-1}
		...
		% ---
		\paragraph{Abraham 1:2} % *ABRAHAM-1-2 
		% ---
			\label{ABRAHAM-1-2}
		...
		% ---
		\paragraph{Abraham 1:3} % *ABRAHAM-1-3 
		% ---
			\label{ABRAHAM-1-3}
		...
		% ---
		\paragraph{Abraham 1:4} % *ABRAHAM-1-4 
		% ---
			\label{ABRAHAM-1-4}
		...
		% ---
		\paragraph{Abraham 1:5} % *ABRAHAM-1-5 
		% ---
			\label{ABRAHAM-1-5}
		...
		% ---
		\paragraph{Abraham 1:6} % *ABRAHAM-1-6 
		% ---
			\label{ABRAHAM-1-6}
		...
		% ---
		\paragraph{Abraham 1:7} % *ABRAHAM-1-7 
		% ---
			\label{ABRAHAM-1-7}
		...
		% ---
		\paragraph{Abraham 1:8} % *ABRAHAM-1-8 
		% ---
			\label{ABRAHAM-1-8}
		...
		% ---
		\paragraph{Abraham 1:9} % *ABRAHAM-1-9 
		% ---
			\label{ABRAHAM-1-9}
		...
		% ---
		\paragraph{Abraham 1:10} % *ABRAHAM-1-10 
		% ---
			\label{ABRAHAM-1-10}
		...
		% ---
		\paragraph{Abraham 1:11} % *ABRAHAM-1-11 
		% ---
			\label{ABRAHAM-1-11}
		...
		% ---
		\paragraph{Abraham 1:12} % *ABRAHAM-1-12 
		% ---
			\label{ABRAHAM-1-12}
		...
		% ---
		\paragraph{Abraham 1:13} % *ABRAHAM-1-13 
		% ---
			\label{ABRAHAM-1-13}
		...
		% ---
		\paragraph{Abraham 1:14} % *ABRAHAM-1-14 
		% ---
			\label{ABRAHAM-1-14}
		...
		% ---
		\paragraph{Abraham 1:15} % *ABRAHAM-1-15 
		% ---
			\label{ABRAHAM-1-15}
		...
		% ---
		\paragraph{Abraham 1:16} % *ABRAHAM-1-16 
		% ---
			\label{ABRAHAM-1-16}
		...
		% ---
		\paragraph{Abraham 1:17} % *ABRAHAM-1-17 
		% ---
			\label{ABRAHAM-1-17}
		...
		% ---
		\paragraph{Abraham 1:18} % *ABRAHAM-1-18 
		% ---
			\label{ABRAHAM-1-18}
		...
		% ---
		\paragraph{Abraham 1:19} % *ABRAHAM-1-19 
		% ---
			\label{ABRAHAM-1-19}
		...
		% ---
		\paragraph{Abraham 1:20} % *ABRAHAM-1-20 
		% ---
			\label{ABRAHAM-1-20}
		...
		% ---
		\paragraph{Abraham 1:21} % *ABRAHAM-1-21 
		% ---
			\label{ABRAHAM-1-21}
		...
		% ---
		\paragraph{Abraham 1:22} % *ABRAHAM-1-22 
		% ---
			\label{ABRAHAM-1-22}
		...
		% ---
		\paragraph{Abraham 1:23} % *ABRAHAM-1-23 
		% ---
			\label{ABRAHAM-1-23}
		...
		% ---
		\paragraph{Abraham 1:24} % *ABRAHAM-1-24 
		% ---
			\label{ABRAHAM-1-24}
		...
		% ---
		\paragraph{Abraham 1:25} % *ABRAHAM-1-25 
		% ---
			\label{ABRAHAM-1-25}
		...
		% ---
		\paragraph{Abraham 1:26} % *ABRAHAM-1-26 
		% ---
			\label{ABRAHAM-1-26}
		...
		% ---
		\paragraph{Abraham 1:27} % *ABRAHAM-1-27 
		% ---
			\label{ABRAHAM-1-27}
		...
		% ---
		\paragraph{Abraham 1:28} % *ABRAHAM-1-28 
		% ---
			\label{ABRAHAM-1-28}
		...
		% ---
		\paragraph{Abraham 1:29} % *ABRAHAM-1-29 
		% ---
			\label{ABRAHAM-1-29}
		...
		% ---
		\paragraph{Abraham 1:30} % *ABRAHAM-1-30 
		% ---
			\label{ABRAHAM-1-30}
		...
		% ---
		\paragraph{Abraham 1:31} % *ABRAHAM-1-31 
		% ---
			\label{ABRAHAM-1-31}
	...
	% -----
	\subsubsection{Abraham 2} % *ABRAHAM-2
	% -----
		\label{ABRAHAM-2}
		
		% ---
		\paragraph{Abraham 2:1} % *ABRAHAM-2-1 
		% ---
			\label{ABRAHAM-2-1}
		...
		% ---
		\paragraph{Abraham 2:2} % *ABRAHAM-2-2 
		% ---
			\label{ABRAHAM-2-2}
		...
		% ---
		\paragraph{Abraham 2:3} % *ABRAHAM-2-3 
		% ---
			\label{ABRAHAM-2-3}
		...
		% ---
		\paragraph{Abraham 2:4} % *ABRAHAM-2-4 
		% ---
			\label{ABRAHAM-2-4}
		...
		% ---
		\paragraph{Abraham 2:5} % *ABRAHAM-2-5 
		% ---
			\label{ABRAHAM-2-5}
		...
		% ---
		\paragraph{Abraham 2:6} % *ABRAHAM-2-6 
		% ---
			\label{ABRAHAM-2-6}
		...
		% ---
		\paragraph{Abraham 2:7} % *ABRAHAM-2-7 
		% ---
			\label{ABRAHAM-2-7}
		...
		% ---
		\paragraph{Abraham 2:8} % *ABRAHAM-2-8 
		% ---
			\label{ABRAHAM-2-8}
		...
		% ---
		\paragraph{Abraham 2:9} % *ABRAHAM-2-9 
		% ---
			\label{ABRAHAM-2-9}
		...
		% ---
		\paragraph{Abraham 2:10} % *ABRAHAM-2-10 
		% ---
			\label{ABRAHAM-2-10}
		...
		% ---
		\paragraph{Abraham 2:11} % *ABRAHAM-2-11 
		% ---
			\label{ABRAHAM-2-11}
		...
		% ---
		\paragraph{Abraham 2:12} % *ABRAHAM-2-12 
		% ---
			\label{ABRAHAM-2-12}
		...
		% ---
		\paragraph{Abraham 2:13} % *ABRAHAM-2-13 
		% ---
			\label{ABRAHAM-2-13}
		...
		% ---
		\paragraph{Abraham 2:14} % *ABRAHAM-2-14 
		% ---
			\label{ABRAHAM-2-14}
		...
		% ---
		\paragraph{Abraham 2:15} % *ABRAHAM-2-15 
		% ---
			\label{ABRAHAM-2-15}
		...
		% ---
		\paragraph{Abraham 2:16} % *ABRAHAM-2-16 
		% ---
			\label{ABRAHAM-2-16}
		...
		% ---
		\paragraph{Abraham 2:17} % *ABRAHAM-2-17 
		% ---
			\label{ABRAHAM-2-17}
		...
		% ---
		\paragraph{Abraham 2:18} % *ABRAHAM-2-18 
		% ---
			\label{ABRAHAM-2-18}
		...
		% ---
		\paragraph{Abraham 2:19} % *ABRAHAM-2-19 
		% ---
			\label{ABRAHAM-2-19}
		...
		% ---
		\paragraph{Abraham 2:20} % *ABRAHAM-2-20 
		% ---
			\label{ABRAHAM-2-20}
		...
		% ---
		\paragraph{Abraham 2:21} % *ABRAHAM-2-21 
		% ---
			\label{ABRAHAM-2-21}
		...
		% ---
		\paragraph{Abraham 2:22} % *ABRAHAM-2-22 
		% ---
			\label{ABRAHAM-2-22}
		...
		% ---
		\paragraph{Abraham 2:23} % *ABRAHAM-2-23 
		% ---
			\label{ABRAHAM-2-23}
		...
		% ---
		\paragraph{Abraham 2:24} % *ABRAHAM-2-24 
		% ---
			\label{ABRAHAM-2-24}
		...
		% ---
		\paragraph{Abraham 2:25} % *ABRAHAM-2-25 
		% ---
			\label{ABRAHAM-2-25}
	...
	% -----
	\subsubsection{Abraham 3} % *ABRAHAM-3
	% -----
		\label{ABRAHAM-3}
		
		% ---
		\paragraph{Abraham 3:1} % *ABRAHAM-3-1 
		% ---
			\label{ABRAHAM-3-1}
		...
		% ---
		\paragraph{Abraham 3:2} % *ABRAHAM-3-2 
		% ---
			\label{ABRAHAM-3-2}
		...
		% ---
		\paragraph{Abraham 3:3} % *ABRAHAM-3-3 
		% ---
			\label{ABRAHAM-3-3}
		...
		% ---
		\paragraph{Abraham 3:4} % *ABRAHAM-3-4 
		% ---
			\label{ABRAHAM-3-4}
		...
		% ---
		\paragraph{Abraham 3:5} % *ABRAHAM-3-5 
		% ---
			\label{ABRAHAM-3-5}
		...
		% ---
		\paragraph{Abraham 3:6} % *ABRAHAM-3-6 
		% ---
			\label{ABRAHAM-3-6}
		...
		% ---
		\paragraph{Abraham 3:7} % *ABRAHAM-3-7 
		% ---
			\label{ABRAHAM-3-7}
		...
		% ---
		\paragraph{Abraham 3:8} % *ABRAHAM-3-8 
		% ---
			\label{ABRAHAM-3-8}
		...
		% ---
		\paragraph{Abraham 3:9} % *ABRAHAM-3-9 
		% ---
			\label{ABRAHAM-3-9}
		...
		% ---
		\paragraph{Abraham 3:10} % *ABRAHAM-3-10 
		% ---
			\label{ABRAHAM-3-10}
		...
		% ---
		\paragraph{Abraham 3:11} % *ABRAHAM-3-11 
		% ---
			\label{ABRAHAM-3-11}
		...
		% ---
		\paragraph{Abraham 3:12} % *ABRAHAM-3-12 
		% ---
			\label{ABRAHAM-3-12}
		...
		% ---
		\paragraph{Abraham 3:13} % *ABRAHAM-3-13 
		% ---
			\label{ABRAHAM-3-13}

			And he said unto me: This is Shinehah,%
				\footnote{%
					% \label{}%
					For this term and ``Olea,'' see \hyperref[DC117-8]{DC 117:8}.
					} 
			which is the sun.  And he said unto me: Kokob, which is star.  And he said unto me: Olea, which is the moon.  And he said unto me: Kokaubeam, which signifies stars, or all the great lights, which were in the firmament of heaven.
		...
		% ---
		\paragraph{Abraham 3:14} % *ABRAHAM-3-14 
		% ---
			\label{ABRAHAM-3-14}
		...
		% ---
		\paragraph{Abraham 3:15} % *ABRAHAM-3-15 
		% ---
			\label{ABRAHAM-3-15}
		...
		% ---
		\paragraph{Abraham 3:16} % *ABRAHAM-3-16 
		% ---
			\label{ABRAHAM-3-16}
		...
		% ---
		\paragraph{Abraham 3:17} % *ABRAHAM-3-17 
		% ---
			\label{ABRAHAM-3-17}
		...
		% ---
		\paragraph{Abraham 3:18} % *ABRAHAM-3-18 
		% ---
			\label{ABRAHAM-3-18}
		...
		% ---
		\paragraph{Abraham 3:19} % *ABRAHAM-3-19 
		% ---
			\label{ABRAHAM-3-19}
		...
		% ---
		\paragraph{Abraham 3:20} % *ABRAHAM-3-20 
		% ---
			\label{ABRAHAM-3-20}
		...
		% ---
		\paragraph{Abraham 3:21} % *ABRAHAM-3-21 
		% ---
			\label{ABRAHAM-3-21}
		...
		% ---
		\paragraph{Abraham 3:22} % *ABRAHAM-3-22 
		% ---
			\label{ABRAHAM-3-22}
			...
			Now the Lord had shown unto me, Abraham, the intelligences that were organized%
				\footnote{%
					% \label{}%
					Note that some believe this ``organization'' refers to an act of creating the intelligences; the idea of a ``spiritual creation'' (around \hyperref[MOSES-3-5]{Moses 3:5} and \hyperref[DC29-31]{DC 29:31--32}) may bolster this belief. I think it means ``arranged'' here, though, or something like that. See \hyperref[DC88-74]{DC 88:74}, 
					}
		...
		% ---
		\paragraph{Abraham 3:23} % *ABRAHAM-3-23 
		% ---
			\label{ABRAHAM-3-23}
		...
		% ---
		\paragraph{Abraham 3:24} % *ABRAHAM-3-24 
		% ---
			\label{ABRAHAM-3-24}
		...
		% ---
		\paragraph{Abraham 3:25} % *ABRAHAM-3-25 
		% ---
			\label{ABRAHAM-3-25}
		...
		% ---
		\paragraph{Abraham 3:26} % *ABRAHAM-3-26 
		% ---
			\label{ABRAHAM-3-26}
		...
		% ---
		\paragraph{Abraham 3:27} % *ABRAHAM-3-27 
		% ---
			\label{ABRAHAM-3-27}
		...
		% ---
		\paragraph{Abraham 3:28} % *ABRAHAM-3-28 
		% ---
			\label{ABRAHAM-3-28}
	...
	% -----
	\subsubsection{Abraham 4} % *ABRAHAM-4
	% -----
		\label{ABRAHAM-4}
		
		% ---
		\paragraph{Abraham 4:1} % *ABRAHAM-4-1 
		% ---
			\label{ABRAHAM-4-1}
		...
		% ---
		\paragraph{Abraham 4:2} % *ABRAHAM-4-2 
		% ---
			\label{ABRAHAM-4-2}
		...
		% ---
		\paragraph{Abraham 4:3} % *ABRAHAM-4-3 
		% ---
			\label{ABRAHAM-4-3}
		...
		% ---
		\paragraph{Abraham 4:4} % *ABRAHAM-4-4 
		% ---
			\label{ABRAHAM-4-4}
		...
		% ---
		\paragraph{Abraham 4:5} % *ABRAHAM-4-5 
		% ---
			\label{ABRAHAM-4-5}
		...
		% ---
		\paragraph{Abraham 4:6} % *ABRAHAM-4-6 
		% ---
			\label{ABRAHAM-4-6}
		...
		% ---
		\paragraph{Abraham 4:7} % *ABRAHAM-4-7 
		% ---
			\label{ABRAHAM-4-7}
		...
		% ---
		\paragraph{Abraham 4:8} % *ABRAHAM-4-8 
		% ---
			\label{ABRAHAM-4-8}
		...
		% ---
		\paragraph{Abraham 4:9} % *ABRAHAM-4-9 
		% ---
			\label{ABRAHAM-4-9}
		...
		% ---
		\paragraph{Abraham 4:10} % *ABRAHAM-4-10 
		% ---
			\label{ABRAHAM-4-10}
		...
		% ---
		\paragraph{Abraham 4:11} % *ABRAHAM-4-11 
		% ---
			\label{ABRAHAM-4-11}
		...
		% ---
		\paragraph{Abraham 4:12} % *ABRAHAM-4-12 
		% ---
			\label{ABRAHAM-4-12}
		...
		% ---
		\paragraph{Abraham 4:13} % *ABRAHAM-4-13 
		% ---
			\label{ABRAHAM-4-13}
		...
		% ---
		\paragraph{Abraham 4:14} % *ABRAHAM-4-14 
		% ---
			\label{ABRAHAM-4-14}
		...
		% ---
		\paragraph{Abraham 4:15} % *ABRAHAM-4-15 
		% ---
			\label{ABRAHAM-4-15}
		...
		% ---
		\paragraph{Abraham 4:16} % *ABRAHAM-4-16 
		% ---
			\label{ABRAHAM-4-16}
		...
		% ---
		\paragraph{Abraham 4:17} % *ABRAHAM-4-17 
		% ---
			\label{ABRAHAM-4-17}
		...
		% ---
		\paragraph{Abraham 4:18} % *ABRAHAM-4-18 
		% ---
			\label{ABRAHAM-4-18}
		...
		% ---
		\paragraph{Abraham 4:19} % *ABRAHAM-4-19 
		% ---
			\label{ABRAHAM-4-19}
		...
		% ---
		\paragraph{Abraham 4:20} % *ABRAHAM-4-20 
		% ---
			\label{ABRAHAM-4-20}
		...
		% ---
		\paragraph{Abraham 4:21} % *ABRAHAM-4-21 
		% ---
			\label{ABRAHAM-4-21}
		...
		% ---
		\paragraph{Abraham 4:22} % *ABRAHAM-4-22 
		% ---
			\label{ABRAHAM-4-22}
		...
		% ---
		\paragraph{Abraham 4:23} % *ABRAHAM-4-23 
		% ---
			\label{ABRAHAM-4-23}
		...
		% ---
		\paragraph{Abraham 4:24} % *ABRAHAM-4-24 
		% ---
			\label{ABRAHAM-4-24}
		...
		% ---
		\paragraph{Abraham 4:25} % *ABRAHAM-4-25 
		% ---
			\label{ABRAHAM-4-25}
		...
		% ---
		\paragraph{Abraham 4:26} % *ABRAHAM-4-26 
		% ---
			\label{ABRAHAM-4-26}
		...
		% ---
		\paragraph{Abraham 4:27} % *ABRAHAM-4-27 
		% ---
			\label{ABRAHAM-4-27}
		...
		% ---
		\paragraph{Abraham 4:28} % *ABRAHAM-4-28 
		% ---
			\label{ABRAHAM-4-28}
		...
		% ---
		\paragraph{Abraham 4:29} % *ABRAHAM-4-29 
		% ---
			\label{ABRAHAM-4-29}
		...
		% ---
		\paragraph{Abraham 4:30} % *ABRAHAM-4-30 
		% ---
			\label{ABRAHAM-4-30}
		...
		% ---
		\paragraph{Abraham 4:31} % *ABRAHAM-4-31 
		% ---
			\label{ABRAHAM-4-31}
	...
	% -----
	\subsubsection{Abraham 5} % *ABRAHAM-5
	% -----
		\label{ABRAHAM-5}
		
		% ---
		\paragraph{Abraham 5:1} % *ABRAHAM-5-1 
		% ---
			\label{ABRAHAM-5-1}
		...
		% ---
		\paragraph{Abraham 5:2} % *ABRAHAM-5-2 
		% ---
			\label{ABRAHAM-5-2}
		...
		% ---
		\paragraph{Abraham 5:3} % *ABRAHAM-5-3 
		% ---
			\label{ABRAHAM-5-3}
		...
		% ---
		\paragraph{Abraham 5:4} % *ABRAHAM-5-4 
		% ---
			\label{ABRAHAM-5-4}
		...
		% ---
		\paragraph{Abraham 5:5} % *ABRAHAM-5-5 
		% ---
			\label{ABRAHAM-5-5}
		...
		% ---
		\paragraph{Abraham 5:6} % *ABRAHAM-5-6 
		% ---
			\label{ABRAHAM-5-6}
		...
		% ---
		\paragraph{Abraham 5:7} % *ABRAHAM-5-7 
		% ---
			\label{ABRAHAM-5-7}
		...
		% ---
		\paragraph{Abraham 5:8} % *ABRAHAM-5-8 
		% ---
			\label{ABRAHAM-5-8}
		...
		% ---
		\paragraph{Abraham 5:9} % *ABRAHAM-5-9 
		% ---
			\label{ABRAHAM-5-9}
		...
		% ---
		\paragraph{Abraham 5:10} % *ABRAHAM-5-10 
		% ---
			\label{ABRAHAM-5-10}
		...
		% ---
		\paragraph{Abraham 5:11} % *ABRAHAM-5-11 
		% ---
			\label{ABRAHAM-5-11}
		...
		% ---
		\paragraph{Abraham 5:12} % *ABRAHAM-5-12 
		% ---
			\label{ABRAHAM-5-12}
		...
		% ---
		\paragraph{Abraham 5:13} % *ABRAHAM-5-13 
		% ---
			\label{ABRAHAM-5-13}
		...
		% ---
		\paragraph{Abraham 5:14} % *ABRAHAM-5-14 
		% ---
			\label{ABRAHAM-5-14}
		...
		% ---
		\paragraph{Abraham 5:15} % *ABRAHAM-5-15 
		% ---
			\label{ABRAHAM-5-15}
		...
		% ---
		\paragraph{Abraham 5:16} % *ABRAHAM-5-16 
		% ---
			\label{ABRAHAM-5-16}
		...
		% ---
		\paragraph{Abraham 5:17} % *ABRAHAM-5-17 
		% ---
			\label{ABRAHAM-5-17}
		...
		% ---
		\paragraph{Abraham 5:18} % *ABRAHAM-5-18 
		% ---
			\label{ABRAHAM-5-18}
		...
		% ---
		\paragraph{Abraham 5:19} % *ABRAHAM-5-19 
		% ---
			\label{ABRAHAM-5-19}
		...
		% ---
		\paragraph{Abraham 5:20} % *ABRAHAM-5-20 
		% ---
			\label{ABRAHAM-5-20}
		...
		% ---
		\paragraph{Abraham 5:21} % *ABRAHAM-5-21 
		% ---
			\label{ABRAHAM-5-21}
